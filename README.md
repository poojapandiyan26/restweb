...
<body>
    ...
    <section class="menu">
        ...
        <div class="menu-items">
            ...
            <div class="item">
                <img src="macroni.jpg" alt="macroni">
                <h3>macroni</h3>
                <p>Rs. 350</p>
            </div>
...
<body>
    ...
    <section class="team">        <h2>Meet Our Team</h2>
        <div class="team-members">
            <div class="member">
                <img src="owner.jpg" alt="Str">
                <h3>Str</h3>
                <p>owner</p>
            </div>
            <div class="member">
                <img src="management team.jpg" alt="Surya">
                <h3>Surya</h3>
                <p>management team</p>
            </div>
            <div class="member">
                <img src="barista.jpg" alt="VD">
                <h3>VD</h3>
                <p>barista</p>
            </div>
            <div class="member">
                <img src="accountant.jpg" alt="Dhanush">
                <h3>Dhanush</h3>
                <p>accountant</p>
            </div>
            <div class="member">
                <img src="chef1.jpg" alt="Jung">
                <h3>Jung</h3>
                <p>chef1</p>
            </div>
            <div class="member">
                <img src="manager.jpeg" alt="Rahman">
                <h3>Rahman</h3>
                <p>manager</p>
            </div>
        </div>
